...
object BsiTokenParserSpec : Spek({
    ...
    describe("parsing $bsiUrl2") {
        val token by memoized { parser.parse(bsiUrl2) }
    ...
    describe("parsing $bsiUrl3") {
        val token by memoized { parser.parse(bsiUrl3) }
    ...
    describe("parsing $bsiUrl4") {
        val token by memoized { parser.parse(bsiUrl4) }
    ...
    describe("parsing $bsiToken1") {
        val token by memoized { parser.parse(bsiToken1) }
    ...
    describe("parsing $bsiToken2") {
        val token by memoized { parser.parse(bsiToken2) }
    ...
    describe("parsing $bsiToken3") {
        val token by memoized { parser.parse(bsiToken3) }
    ...
    describe("parsing $bsiToken4") {
        val token by memoized { parser.parse(bsiToken4) }
